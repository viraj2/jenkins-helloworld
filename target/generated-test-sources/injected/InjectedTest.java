...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"org.jenkins-ci.plugins:helloworld:1.0-SNAPSHOT");
    Map parameters = new HashMap();
    parameters.put("basedir","D:\\Jenkins plugins\\helloworld");
    parameters.put("artifactId","helloworld");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","D:\\Jenkins plugins\\helloworld\\target\\classes");
    parameters.put("testOutputDirectory","D:\\Jenkins plugins\\helloworld\\target\\test-classes");
